...
public class autoDepotSide extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        robotAuto.verticalDriveDistance(0.1,7);
        ...
        robotAuto.verticalDriveDistance(-0.1,-0.4);

        sleep(200);

        robotAuto.verticalDriveDistance(0.1, 7.5);
        ...
        Thread.sleep(200);
        curr2 = robot.spine.getCurrentPosition();
        robot.spine.setPower(-1);
        Thread.sleep(500);
        ...
        robotAuto.verticalDriveDistance(0.3, 10);
