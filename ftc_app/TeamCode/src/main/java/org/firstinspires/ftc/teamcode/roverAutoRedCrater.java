...
@Autonomous(name="autRedCrater",group="rover")
public class roverAutoRedCrater extends LinearOpMode {
    roverHMAP robot;
    roverAuto robotAuto;
    AnalogInput ods;
    String leftColor;
    ...
    public void runOpMode() throws InterruptedException{
        ...
        robotAuto.verticalDrive(0.2);
        do {
            if (robot.dMArmL.getDistance(DistanceUnit.CM) < 30 || robot.dMArmR.getDistance(DistanceUnit.CM) < 30) {
                robotAuto.stopDriving();
                break;
            }
        ...
        if(!middle) {
            ...
            robot.MArmR.setPosition(0.75);
            robot.MArmL.setPosition(0.15);
            robotAuto.verticalDriveDistance(-0.25, -11.7);
        } else {
            robotAuto.verticalDriveDistance( -0.25,-4.7);
        ...
        robotAuto.verticalDriveDistance(0.4,36);
        while(robotAuto.getHeading()>-133){
